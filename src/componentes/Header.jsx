...
function Header() {
  return (
    <header className="bg-gray-900 text-white py-12 shadow-xl">
      <div className="container mx-auto text-center px-6">
        ...
        <div className="mt-8">
          <a
            href="#"
            className="bg-white text-gray-700 hover:bg-purple-100 font-semibold py-3 px-6 rounded-full shadow-lg text-lg transition duration-300 ease-in-out"
          >
